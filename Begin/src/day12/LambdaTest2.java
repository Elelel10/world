...
public class LambdaTest2 {
	...
	public static void main(String[] args) {
		//[1] 람다식 ###을 출력하는 람다식을 구현한 뒤 함수를 호출해보세요
		MyFunc mf=()->System.out.println("###");
		mf.func();
		//[2] 람다식 \\(6v6)// 출력하는 람다식 구현하고 함수 호출
		MyFunc mf2=()->System.out.println("\\\\(6v6)//");
		mf2.func();
		//[3] YourFunc 매개변수를 받으면 거듭제곱값을 출력하는 람다식 구현한 뒤 함수 호출
		YourFunc yf=a->System.out.println(a*a);
		yf.foo(5);
		//[4] YourFunc 매개변수에서 3을 빼주는 값을 출력하는 람다식 구현한 뒤 함수 호출
		...
		//[6] HerFunc 문자열 2개를 받아서 2개의 문자열을 연결해서 반환하되 첫글자는 대문자로 나머지는 소문자로 만들어서 반환하는 람다식 구현 호출하기
		HerFunc hf2=(a,b)->{
			char c1=a.charAt(0);
			char c2=b.charAt(0);
