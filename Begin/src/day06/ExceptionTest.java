 ...
 * 		단, 예외가 있다. 시스템 종료코드가 있을 경우는 finally블럭이 실행되지 않음
 * }
 */
...
public class ExceptionTest {
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println("분모가 0이 되어서는 안돼요!");
			System.exit(-1);//시스템 종료(정수 아무거나 ok)
		}catch(Exception e) {
			System.out.println("기타오류 발생: "+e.getMessage());
			//String getMessage():예외메세지를 문자열로 반환한다.
		}finally {
			System.out.println("###반드시 실행되어야 하는 코드입니다###");
		}
