...
public class Polymorphism {
	...
	public static void main(String[] args) {
		...
		//재정의한 메소드의 경우 hs로 호출하면 자식의 것이 우선적용된다
